    ...
    <div className="mt-[100px] w-screen flex flex-col justify-center items-center">
      <div className="flex tablet:w-[27.75rem] w-72 laptop:w-[815px]">
        <Typography variant="p" className="text-center">
          Il <i><strong>JEIOM</strong></i>, Junior Enterprise Italy October Meeting, è un evento che coinvolge
          l&apos;intero Network delle JE italiane.
        </Typography>
      </div>

      <div className=" pt-10 tablet:pt-40 w-screen flex flex-col laptop:flex-row laptop:justify-evenly">
        <div className="flex flex-col justify-center ">
          ...
          <div className="flex justify-center ">
            ...
            <Typography variant="p" className="w-72 text-center mt-8">
        ...
        <div className=" flex flex-col pt-10 laptop:pt-0">
          ...
          <div className="flex justify-center ">
            <Typography variant="p"
                        className="w-72 text-center mt-8">
