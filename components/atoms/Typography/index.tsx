  ...
  switch (variant) {
    ...
    case "p":
      return (
        <p
          className={classNames(
            "antialiased font-normal text-white text-[15px] tablet:text-[14px] laptop:text-[20px]",
            className ?? ""
          )}
        >
          {children}
    ...
    case "sponsorTitle":
      return (
        <p
          className={classNames(
            "antialiased font-semibold text-white text-[37px] tablet:text-[40px] laptop:text-[54px]",
            className ?? ""
          )}
        >
          {children}
